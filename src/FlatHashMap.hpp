...
{
    static sherwood_v3_entry_constexpr special_end_entry()
    {
...
template<typename T>
const sherwood_v3_entry_constexpr<T> EntryDefaultTable<T>::table[min_lookups] = {{}, {}, {}, sherwood_v3_entry_constexpr<T>::special_end_entry()};
...
public:
    ...
    struct templated_iterator
    {
        ...
        templated_iterator (const EntryPointer &ep)
            : current (ep)
        {}
